...
// SDK-compat (KILLHAUS): trace-типы отсутствуют в текущем hl2sdk-cs2, плагину не нужны.
#ifndef KH_TRACE_COMPAT
#define KH_TRACE_COMPAT
struct Ray_t {};
class CHitBox {};
enum RayType_t { RAY_TYPE_LINE = 0 };
#endif
